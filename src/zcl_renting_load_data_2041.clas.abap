CLASS zcl_renting_load_data_2041 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_renting_load_data_2041 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA: lt_brands    TYPE TABLE OF zrent_brands_41,
          lt_cars      TYPE TABLE OF zrent_cars_2041,
          lt_customers TYPE TABLE OF zrent_custome_41.
...
DELETE FROM zrent_brands_41.
INSERT zrent_brands_41 FROM TABLE @lt_brands.
SELECT * FROM zrent_brands_41 INTO TABLE @lt_brands.
out->write( sy-dbcnt ).
...
( matricula = '2174FHF' marca = 'KIA' modelo = 'CEED' color = 'AZUL' motor = '4.2' potencia = '340' und_potencia = 'CV' combustible = 'GASOLINA' consumo = '10.00' fecha_fabr = '20200617' puertas = '5' precio = '160' moneda = 'USD' alquilado = 'X'
...
( matricula = '2837KFF' marca = 'MERCEDES' modelo = 'CLASE B' color = 'NEGRO' motor = '2.0' potencia = '200' und_potencia = 'CV' combustible = 'GASOLINA' consumo = '7.00' fecha_fabr = '20200726' puertas = '5' precio = '160' moneda = 'USD' alquilado = 'X'
...
DELETE FROM zrent_cars_2041.
INSERT zrent_cars_2041 FROM TABLE @lt_cars.
SELECT * FROM zrent_cars_2041 INTO TABLE @lt_cars.
out->write( sy-dbcnt ).
...
DELETE FROM zrent_custome_41.
INSERT zrent_custome_41 FROM TABLE @lt_customers.
SELECT * FROM zrent_custome_41 INTO TABLE
@lt_customers.
out->write( sy-dbcnt ).
